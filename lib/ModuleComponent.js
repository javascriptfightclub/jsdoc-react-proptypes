...
var ModuleComponent = function (_Component) {
    _inherits(ModuleComponent, _Component);

    function ModuleComponent() {
        _classCallCheck(this, ModuleComponent);

        return _possibleConstructorReturn(this, (ModuleComponent.__proto__ || Object.getPrototypeOf(ModuleComponent)).apply(this, arguments));
    }
